...
insert into reservation (id, date_reservation, hotel_id, customer_id, date_start, date_end, total_days, price) VALUES
                                                                                                                    ('12345678-1234-5678-1234-567812345678', now(), 1, 'BBMB771012HMCRR022', '2024-08-01', '2024-08-07', 7, 77.00),
                                                                                                                    ('22345678-1234-5678-1234-567812345678', now(), 2, 'VIKI771012HMCRG093', '2024-08-01', '2024-08-07', 7, 22.00),
                                                                                                                    ('32345678-1234-5678-1234-567812345678', now(), 3, 'VIKI771012HMCRG093', '2024-08-01', '2024-08-01', 1, 112.00),
                                                                                                                    ('52345678-1234-5678-1234-567812345678', now(), 3, 'VIKI771012HMCRG093', '2024-08-12', '2024-08-14', 2, 74.00);
...
insert into ticket (id, price, fly_id, customer_id, departure_date, arrival_date, purchase_date) VALUES
                                                                                                     ...
                                                                                                     ('42345678-1234-5678-5233-567812345678', 560.77, 7, 'VIKI771012HMCRG093', '2024-08-12 20:00:00', '2024-08-12 22:00:00', now());
